...
\begin{figure*}[!t]
  \centering
  \includegraphics[width=\linewidth]{figures/loss_by_phase.png}\\[0.3ex]
  {\footnotesize (a)}\\[0.8ex]
  \includegraphics[width=\linewidth]{figures/rtt_by_phase.png}\\[0.3ex]
  {\footnotesize (b)}
...
Together, Figures~\ref{fig:outage-preserving} and~\ref{fig:phase-metrics}
