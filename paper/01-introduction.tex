...
showing 0\,ms mean data-plane outage at GSL handover where OSPF incurs
multi-second black holes, 0\% packet loss through the handover phases on every
grid size, and millisecond-range shortest-path recomputation, together with
measurement of the regime where centralized install does not yet outperform
distributed reconvergence under unplanned bulk failure.
