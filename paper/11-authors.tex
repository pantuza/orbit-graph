\begin{IEEEbiography}[{
    ...
    is a PhD candidate in Computer Science at the Universidade Federal de Minas Gerais (UFMG) working at the LeCom - Computers Engineering Laboratory.
    He received his M.S. at the Universidade Federal de Minas Gerais (UFMG) in Belo Horizonte, Brazil. 
    His research areas are Networks, Distributed Systems, Observability and Algorithms.
\end{IEEEbiography}

\begin{IEEEbiography}[{\includegraphics[width=0.8\linewidth,clip,keepaspectratio]{figures/flip-bio.jpg}}]{Luiz Vieira}
