\begin{IEEEbiography}[{
    \includegraphics[width=0.8\linewidth,clip,keepaspectratio]{figures/pantuza.jpg}}]{Gustavo Pantuza}
...
\begin{IEEEbiography}[{\includegraphics[width=0.8\linewidth,clip,keepaspectratio]{figures/Flip.jpg}}]{Luiz Vieira}
